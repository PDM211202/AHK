...
SendInput, for (let i = 0; i < 500; i += 2) {let s = m.search(i);if (s == -1) { n = i - 2; break;}};
SendInput, for (let i = 0; i <= n; i += 2) { let t = "kkcode_" + i; let d = document.getElementById(t).shadowRoot.innerHTML; arr.push(d); }; 
